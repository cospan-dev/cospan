...
export const load: PageServerLoad = async ({ params }) => {
	...
	let followers = { items: [] as any[], cursor: null as string | null, totalCount: 0 };
	try {
		followers = await listFollows({ did: params.did, direction: 'followers', limit: 30 });
	} catch {}
	...
	return { profile, followers, repos, did: params.did };
};
